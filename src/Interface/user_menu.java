...
public class user_menu extends javax.swing.JFrame implements Menu{
    ...
    public user_menu(UserSession userSession) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ModificarCompCtrTest mcctr = new ModificarCompCtrTest(session);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        UserReadFileCtr usrFilectr = new UserReadFileCtr(session);
        usrFilectr.getData();
