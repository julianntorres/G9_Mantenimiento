...
public class ModificarCtr implements ActionListener {
    ...
    public ModificarCtr(UserSession userSession) {
        this();
    ...
    private void searchAdministrador() {
    try {
...
private void searchTrabajador() {
    ...
    private void performActualizar() {
        ...
        if (hilos.size() < 5) {
            ...
            insertAuditLog(adminId, "Modificación de usuario: " + id + ", nombre: " + nombre + ", apellido: " + apellido);
        } else {
            System.out.println("Numero maximo de peticiones");
        }
    }

    private void performLlenar() {
